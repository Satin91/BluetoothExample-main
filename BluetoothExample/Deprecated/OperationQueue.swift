...
//
//    init(queue: BLEQueue2) {
//        self.queue = queue
//    }
//
//    func addOperation(queue: BLEQueue, handler: @escaping () -> Void) {
...
//
//        guard let uiOperation = self.cancellableOperations.last else { return }
//        uiOperation.queuePriority    = .high
//        uiOperation.qualityOfService = .userInteractive
//
//      //  queue.addOperation(uiOperation)
//
...
//}
//
//class BLEQueue2: OperationQueue {
//
...
//
//
//    lazy var manager = OperationManager(queue: self)
//
//    func start(block: @escaping ()->Void ) {
//
//
//        manager.addOperation(queue: self, handler: block)
//
